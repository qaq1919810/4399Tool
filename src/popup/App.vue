    ...
    <div class="app">
        <div class="header">
            ...
            <div class="header-btns">
                <el-button size="small" @click="openWindow" title="独立窗口">⧉</el-button>
        ...
        <div v-if="selectedUsers.length > 0" class="batch-bar">
            ...
            <el-dropdown @command="batchMoveToFolder" trigger="click">
                <el-button size="small" type="primary">
                    移到文件夹 <el-icon><ArrowDown /></el-icon>
                </el-button>
                <template #dropdown>
                    <el-dropdown-menu>
...
} from '../js/feature/folderManager.mjs'
...
async function saveCurrentAccount() {
    const btnAuth = auth.value
    if (!btnAuth) return

    ElMessage.info('正在抓取账号数据...')

    const userData = await getUserInfo(btnAuth.puser)
    if (!userData) {
